...
export default function createDevServer({
  ...
  const buildedNodeDir = path.join(process.cwd(), '.snext/node')
  ...
  // Get user compiled snext runtime
  const getFreshSnextRunTime = compileNodeCommonJS
    ? async () => {
